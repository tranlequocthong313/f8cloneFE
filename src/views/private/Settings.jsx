...
const Settings = () => {
    ...
    const changeAvatar = async () => {
        try {
            ...
            const photoURL = await uploadMedia(image.avatar);
            if (!photoURL) return;
                        ...
                        <div className={styles.wrapper}>
                            ...
                            <div className={styles.container}>
                                ...
                                <FieldInput
                                    ...
                                    placeholder={
                                        'Eg. https://www.facebook.com/hoclaptrinhf8'
                                    }
                                ...
                                <FieldInput
                                    title={'Youtube'}
                                    placeholder={
                                        'Eg. https://www.youtube.com/c/F8VNOfficial'
                                    }
                                    maxLength={150}
                                    onChange={(e) =>
                                        setSocial((prev) => {
                                ...
                                <FieldInput
                                    title={'Instagram'}
                                    placeholder={
                                        'Eg. https://www.instagram.com/hoclaptrinhf8/'
                                    }
                                    maxLength={150}
                                    onChange={(e) =>
                                        setSocial((prev) => {
                                    ...
                                    isEditMode={isEditMode.includes(
                                        'instagram'
                                    )}
                                ...
                                <FieldInput
                                    title={'Twitter'}
                                    placeholder={
                                        'Eg. https://twitter.com/hoclaptrinhf8'
                                    }
                                    maxLength={150}
                                    onChange={(e) =>
                                        setSocial((prev) => {

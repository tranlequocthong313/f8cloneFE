...
const publicRoutes = [
  ...
  { path: '/search', component: Search, layout: HideSidebar },
  { path: '/search/blog', component: Search, layout: HideSidebar },
  { path: '/search/video', component: Search, layout: HideSidebar },
  { path: '/search/course', component: Search, layout: HideSidebar },
